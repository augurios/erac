...
//Admin
import AdminPanel from "../pages/Dashboard/Pages/AdminPanel.vue";

//Cases
import MyCases from "../pages/Dashboard/Pages/MyCases.vue";
import CaseViewer from "../pages/Dashboard/Pages/CaseViewer.vue";

//chat
import VideoChat from "../pages/Dashboard/Pages/VideoChat.vue"; 
...
const routes = [
  ...
  authPages,
  {
    ...
    children: [
      ...
      {
          path: "/cases",
          components: { default: MyCases},
          name: "Mis Casos"
      },
      {
        path: "/cases/:id",
        components: { default: CaseViewer},
        name: "Visor de Caso"
      },
      {
        path: "/cases/:id/chat-room",
        components: { default: VideoChat},
        name: "Video llamada"
      },
      {
        path: "calendar",
