        ...
        <md-card-content>
          ...
          >
            ...
            <md-table-row slot="md-table-row" slot-scope="{ item }">
              ...
              <md-table-cell md-label="Apellidos" md-sort-by="lastname">{{item.lastname}}</md-table-cell>
              <md-table-cell md-label="Email" md-sort-by="email">{{item.email}}</md-table-cell>
              <md-table-cell md-label="Telefono" md-sort-by="phone">{{ item.phone }}</md-table-cell>
              <md-table-cell md-label="Cedula" md-sort-by="cedula">{{ item.cedula }}</md-table-cell>
              <md-table-cell md-label="Rol" md-sort-by="cedula">{{ item.roles[0].name }}</md-table-cell>
...
export default {
  ...
  data() {
    return {
      ...
      footerTable: ["Nombre", "Apellidos", "Email", "Telefono", "Cedula", "Rol", "Acciones"],
      searchQuery: "",
